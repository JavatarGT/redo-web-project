	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				...
				echo '<div class="row">';
				echo $this->Form->input('nombre', array('label' => array('text'=> 'Nombre de Programa'), 'type' =>  'text'));
...
<?php $this->Js->buffer("
	 $('#ProgramaEditarForm').bootstrapValidator({
		excluded: [':disabled'],
		feedbackIcons: {
		...
		fields: {
			\"data[Programa][nombre]\": {
				validators: {
					notEmpty: {
						message: 'Es necesario que ingrese un nombre de Programa'
					}
				}
			},
