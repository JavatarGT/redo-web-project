...
<script type="text/javascript">
    ...
    function grafica(){
        ...
        $.ajax({async:true,
            ...
            type:'post', 
            url:'<?php echo $this->base;?>/charts/consuimpc'
        });
    }
    function cargarGrafica(){
        var txt = 'Total de Consultas y Reconsultas desde ' + $('#FechaInicial').val() + ' a '+$('#FechaFinal').val();
    $('#container').highcharts({
        ...
        yAxis: {
            title: {
                text: 'Total de Impresiones Clínicas'
            }
