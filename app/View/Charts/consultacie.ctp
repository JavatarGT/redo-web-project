...
<script type="text/javascript">
    ...
    function grafica(){
        ...
        //             }, 
        //             type:'post', 
        //             url:'<?php echo $this->base;?>/charts/reconsucie'
        //         });
        //     }, 
        //     type:'post', 
        //     url:'<?php echo $this->base;?>/charts/consucie'
        // });
        $.ajax({async:true,
            data:{Consulta},
            dataType:'html', 
            ...
            type:'post', 
            url:'<?php echo $this->base;?>/charts/consucietot'
        });
    }
    function cargarGrafica(){
        var txt = 'Total de diagnósticos CIE-10 desde ' + $('#FechaInicial').val() + ' a '+$('#FechaFinal').val();
    $('#container').highcharts({
        chart: {
            type: 'column'
        },
        title: {
            text: 'Servicio prestado en Clínica'
        },
        subtitle: {
            text: txt
        },
