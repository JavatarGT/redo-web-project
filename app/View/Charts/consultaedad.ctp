...
<script type="text/javascript">
        ...
        $.ajax({async:true,
            ...
            success:function (data, textStatus) {
                ...
                $.ajax({async:true,
                    ...
                    type:'post', 
                    url:'<?php echo $this->base;?>/charts/consedad/2'
                });
            }, 
            type:'post', 
            url:'<?php echo $this->base;?>/charts/consedad/1'
        });
        $.ajax({async:true,
            data:{Consulta},
            dataType:'html', 
            ...
            type:'post', 
            url:'<?php echo $this->base;?>/charts/consedad/3'
        });
    }
    function cargarGrafica(){
        var txt = 'Consultas y Reconsultas por Edad desde ' + $('#FechaInicial').val() + ' a '+$('#FechaFinal').val();
  ...
  function cargarGrafica1(){
        var txt = 'Total de Consultas y Reconsultas por Edad desde ' + $('#FechaInicial').val() + ' a '+$('#FechaFinal').val();
